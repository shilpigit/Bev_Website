(function () {//The build will inline common dependencies into this file.
...
define("waitMe", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.waitMe;
    };
}(this)));
